...
class MenuTry extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
           ...
           <div id="outer-container">
             <Menu style={menustyle} pageWrapId={ "page-wrap" } outerContainerId={ "outer-container" }>
             <main id="page-wrap">

                 <a id="Open now" className="menu-item" href=" ">Open now</a>
                 <a id="Cost" className="menu-item" href="/">Cost</a>
                 <a onClick={this.handleMenu} className="menu-item--small" href="">Menu</a>
                 </main>
             </Menu>
             </div>  
